    ...
    <div>
      <Grid container columnSpacing={4} rowSpacing={4}>
        ...
        <Grid item xs={12}>
          ...
          <Button variant="contained" style={{marginRight:'15px'}} onClick={sendData} disabled={loading}>
            Ýatda saklamak 
            <CircularProgress style={loading ? {display:'block'} : {display:'none'}} sx={{ml:'10px'}} size={20}></CircularProgress>
          </Button>
          <Button variant="contained" style={{backgroundColor:'gray'}} onClick={sendData} disabled={loading}>
            Markedine gitmek
            {/* <CircularProgress style={loading ? {display:'block'} : {display:'none'}} sx={{ml:'10px'}} size={20}></CircularProgress> */}
          </Button>
        </Grid>
